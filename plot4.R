...
##Add Legend
legend("topright",cex=0.5, col=c("black", "red", "blue"), lty=1, lwd=2,
       legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))

##Upper right graph
plot(energy$Voltage~energy$Datetime, type="l", 
     ylab="Voltage", xlab="datetime")


##Lower right graph

plot(energy$Global_reactive_power~energy$Datetime, type="l", 
